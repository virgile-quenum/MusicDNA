...
def render(df):
    ...
    with tab1:
        ...
        agg_dict = {"hours": ("ms", lambda x: round(x.sum()/3600000, 2)),
                    "plays": ("ms", "count")}
        if has_skip:
        ...
        colors = [VIOLET] * len(artist_stats)
        ...
        if has_skip:
            st.markdown(
                ...
                "text-transform:uppercase;letter-spacing:.1em;margin:16px 0 8px;'>Skip rates</div>",
            ...
            for i, row in artist_stats.iterrows():
                ...
                with cols[i % 4]:
                    st.markdown(
                        ...
                        "<span style='font-size:.78em;color:#888;'>" + str(row["artistName"])[:22] + "</span>"
    ...
    with tab2:
        ...
        st.markdown(
            "<div style='color:#555;font-size:.78em;'>"
        ...
        if sub.empty:
            ...
            if silent_months > 12:
                st.markdown(
                    ...
                    "border-radius:8px;padding:10px 14px;margin:12px 0;color:#f87171;font-size:.85em;'>"
            ...
            if skip_r is not None:
                ...
                st.markdown(
                    "<div style='color:#555;font-size:.82em;margin:8px 0;'>"
            ...
            for i, row in top_tracks.iterrows():
                ...
                with cols[i % 2]:
                    st.markdown(
                        ...
                        "<span style='color:#555;font-size:.78em;'>" + str(row["hours"]) + "h</span>"
                        "<span style='color:#444;font-size:.78em;'>last: " + str(row["last_fmt"]) + "</span>"
                        "</div>"
                        "</div>",
                        unsafe_allow_html=True
                    )
    ...
    with tab5:
        ...
        st.caption("Tracks with 20+ plays all-time. Silent for the last 12 months. Sorted by plays.")
        ...
        if graveyard.empty:
            ...
            with c1:
                st.markdown(
                    ...
                    "<div style='font-size:.72em;color:#555;margin-top:4px;'>forgotten tracks</div>"
            ...
            with c2:
                st.markdown(
                    ...
                    "<div style='font-size:.72em;color:#555;margin-top:4px;'>total plays in their lifetime</div>"
                    "</div>", unsafe_allow_html=True
                )
            with c3:
                ...
                st.markdown(
                    ...
                    "<div style='font-size:.72em;color:#555;margin-top:4px;'>avg months of silence</div>"
                    "</div>", unsafe_allow_html=True
                )
